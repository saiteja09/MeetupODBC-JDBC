...
public class CategoriesDataProcessor extends DataProcessor {

	/**
	 * This method is to build appropriate HTTP request that is to be invoked
	 * to get the required data from the table Categories 
	 * 
	...
	public Request buildRequest(StatementContext ctx, InvocationContext invCtx) throws Exception {
		...
		url = baseURL + "/2/categories?page=200" + "&key=" + customProperties.get("KEY");
