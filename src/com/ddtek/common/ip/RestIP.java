...
import com.ddtek.meetup.connection.ConnectionHelper;
...
public class RestIP implements oajava.sql.ip {
	...
	private void populateCatalogInformation() {
		...
		sessionContext.setSessionProperty(RestIPConstants.SQL_DBMS_NAME_PROP, "Meetup");
		sessionContext.setSessionProperty(RestIPConstants.CATALOG_NAME_PROP, "OpenAccess");
		sessionContext.setSessionProperty(RestIPConstants.SCHEMA_NAME_PROP, "Meetup");
